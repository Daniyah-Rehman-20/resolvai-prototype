...
## Merchant mismatch
When the bank is debited and gateway reports success but merchant confirmation fails, reconcile gateway and merchant records before any simulated refund.
